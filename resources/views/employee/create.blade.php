                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                              <label for="first_name" class="col-md-3 col-form-label">Nama Employee</label>
                              <div class="col-md-9">
                                <input type="text" name="namaEmploy" id="namaEmploy" class="form-control is-invalid">
                            ...
                            <div class="form-group row">
                              <label for="company_id" class="col-md-3 col-form-label">Level</label>
                              <div class="col-md-9">
